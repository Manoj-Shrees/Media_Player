...
/* package */ final class DemoUtil {
  ...
  public static String buildTrackName(Format format) {
    ...
    if (MimeTypes.isVideo(format.sampleMimeType)) {
      trackName = joinWithSeparator("Res : "+buildResolutionString(format),buildSampleMimeTypeString(format));
    }

    else if (MimeTypes.isAudio(format.sampleMimeType)) {
      trackName = joinWithSeparator("Lang : "+buildLanguageString(format),buildSampleMimeTypeString(format));
    }
